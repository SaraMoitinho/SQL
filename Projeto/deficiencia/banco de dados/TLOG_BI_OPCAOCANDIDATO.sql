CREATE OR REPLACE TRIGGER DBVESTIB.TLOG_BI_OPCAOCANDIDATO
AFTER DELETE OR UPDATE OR INSERT ON DBVESTIB.OPCAOCANDIDATO
...
BEGIN
  ...
  IF INSERTING OR UPDATING THEN
    INSERT INTO DBVESTIB.OPCAOCANDIDATO_LOG_BI
      (COD_LOG_BI,
       CODCONC,
       CODINSC,
       NROOPC,
       ...
       DAT_OPERACAO_LOG)
    VALUES
      (DBVESTIB.OPCAOCANDIDATO_LOG_BI_S.NextVal,
       :NEW.CODCONC,
       :NEW.CODINSC,
       :NEW.NROOPC,
       :NEW.CODCUR,
