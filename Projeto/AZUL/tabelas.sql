...
insert into dbvestib.destino_azul(cod_destino_azul,dsc_destino_azul, nom_aeroporto)
values (dbvestib.destino_azul_s.nextval,'Brasília ' , 'Aeroporto Internacional de Brasília / Presidente Jucelino Kubitschek ');
insert into dbvestib.destino_azul(cod_destino_azul,dsc_destino_azul, nom_aeroporto)
values (dbvestib.destino_azul_s.nextval,'Florianópolis ' , ' Aeroporto Internacional de Florianópolis/Hercílio Luz ');
insert into dbvestib.destino_azul(cod_destino_azul,dsc_destino_azul, nom_aeroporto)
values (dbvestib.destino_azul_s.nextval,'Ilhéus ', 'Aeroporto de Ilhéus/Bahia - Jorge Amado ');
insert into dbvestib.destino_azul(cod_destino_azul,dsc_destino_azul, nom_aeroporto)
values (dbvestib.destino_azul_s.nextval,'Joinville ' , 'Aeroporto de Joinville/SC – Lauro Carneiro de Loyola ');
insert into dbvestib.destino_azul(cod_destino_azul,dsc_destino_azul, nom_aeroporto)
values (dbvestib.destino_azul_s.nextval,'Salvador ', 'Aeroporto Internacional de Salvador - Dep. Luís Eduardo Magalhães ');
insert into dbvestib.destino_azul(cod_destino_azul,dsc_destino_azul, nom_aeroporto)
values (dbvestib.destino_azul_s.nextval,'São Paulo ', 'Aeroporto Internacional de São Paulo/Guarulhos - Governador André Franco Montoro ');
