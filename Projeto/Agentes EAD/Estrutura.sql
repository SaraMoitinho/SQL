...
CREATE UNIQUE INDEX DBSIAF.IX_LOCALIZADOR on DBSIAF.ESTRUTURA_ORGANIZACIONAL (UPPER(TRIM(TRANSLATE(DSC_COD_LOCALIZADOR,'¡…Õ”⁄¬ Œ‘€¿»Ã“ŸƒÀœ÷‹√’«—·ÈÌÛ˙‚ÍÓÙ˚‡ËÏÚ˘‰ÎÔˆ¸„ıÁÒA@#$%®&*()-_+=|\/?!{},.;:"<>[]''^~`¥∫∞™''','AEIOUAEIOUAEIOUAEIOUAOCNaeiouaeiouaeiouaeuouaocnA'))))TABLESPACE TS_INDX_DBSIAF;
