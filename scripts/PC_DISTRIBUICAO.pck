CREATE OR REPLACE PACKAGE DBVESTIB.PC_DISTRIBUICAO IS
	-- *****************************************************
	...
	FUNCTION F_STATUS_DISTIB_CADERNO(P_CODCONC DBVESTIB.CADERNO.CODCONC%TYPE,
									 P_CODCAD  DBVESTIB.CADERNO.CODCAD%TYPE) RETURN CHAR;
	...
	FUNCTION F_STATUS_DISTIB_CURSO(P_CODCONC DBVESTIB.CADERNO.CODCONC%TYPE,
								   ...
								   P_CODCUR  DBVESTIB.CURSO.CODCUR%TYPE) RETURN CHAR;
	...
	FUNCTION F_STATUS_DISTIB_BAIRRO(P_CODCONC    DBVESTIB.CADERNO.CODCONC%TYPE,
									...
									P_NOM_BAIRRO DBVESTIB.CANDIDATO.BAICAN%TYPE) RETURN CHAR;
	...
	FUNCTION F_STATUS_DISTIB_SALA(P_CODCONC   DBVESTIB.CADERNO.CODCONC%TYPE,
								  ...
								  P_COD_ETAPA DBVESTIB.ETAPA_CONCURSO.COD_ETAPA%TYPE) RETURN CHAR;
	...
	FUNCTION F_STATUS_DISTIB_CAMPUS(P_CODCONC   DBVESTIB.CADERNO.CODCONC%TYPE,
									P_CODCAD    DBVESTIB.CADERNO.CODCAD%TYPE,
									P_CODCUR    DBVESTIB.CURSO.CODCUR%TYPE,
									P_CODCAMPUS DBVESTIB.CANDIDATO.CODCAMPROXRESIDENCIA%TYPE) RETURN CHAR;
	...
	FUNCTION F_CAND_ALOC_CADERNO(P_CODCONC DBVESTIB.CADERNO.CODCONC%TYPE,
								 P_CODCAD  DBVESTIB.CADERNO.CODCAD%TYPE) RETURN NUMBER;
	...
	FUNCTION F_CAND_ALOC_CURSO(P_CODCONC DBVESTIB.CADERNO.CODCONC%TYPE,
							   P_CODCAD  DBVESTIB.CADERNO.CODCAD%TYPE,
							   P_CODCUR  DBVESTIB.CURSO.CODCUR%TYPE) RETURN NUMBER;
	...
	FUNCTION F_CAND_ALOC_BAIRRO(P_CODCONC    DBVESTIB.CADERNO.CODCONC%TYPE,
								...
								P_CODCUR     DBVESTIB.CURSO.CODCUR%TYPE,
								P_NOM_CIDADE DBVESTIB.CANDIDATO.CIDCAN%TYPE,
								P_NOM_BAIRRO DBVESTIB.CANDIDATO.BAICAN%TYPE) RETURN NUMBER;
	...
	FUNCTION F_CAND_ALOC_SALA(P_CODCONC   DBVESTIB.CADERNO.CODCONC%TYPE,
							  P_CODLOC    DBVESTIB.CADERNO.CODCAD%TYPE,
							  P_CODSAL    DBVESTIB.CADERNO.CODCAD%TYPE,
							  P_COD_ETAPA DBVESTIB.ETAPA_CONCURSO.COD_ETAPA%TYPE) RETURN NUMBER;
	...
	FUNCTION F_CAND_ALOC_CAMPUS(P_CODCONC   DBVESTIB.CADERNO.CODCONC%TYPE,
								P_CODCAD    DBVESTIB.CADERNO.CODCAD%TYPE,
								P_CODCUR    DBVESTIB.CURSO.CODCUR%TYPE,
								P_CODCAMPUS DBVESTIB.CANDIDATO.CODCAMPROXRESIDENCIA%TYPE) RETURN NUMBER;
...
CREATE OR REPLACE PACKAGE BODY DBVESTIB."PC_DISTRIBUICAO" IS
    ...
    */
	PROCEDURE SP_DISTRIBUIR_CANDIDATO(P_CODCONC   DBVESTIB.DISTRIBUICAO_CANDIDATO.CODCONC%TYPE,
		...
		V_CODCAM    DBVESTIB.CAMPUS.CODCAM%TYPE;
	BEGIN
									 ...
									 WHERE CDS.CODCONC = P_CODCONC
										   ...
										   AND NOT EXISTS (SELECT 1
											 ...
											 WHERE CDS.CODCONC = CDS1.CODCONC
												   ...
												   AND ((CDS.CODINSTITUICAO = CDS1.CODINSTITUICAO) AND (CDS.CODCAM = CDS1.CODCAM) AND (CDS.CODCUR = RCC.CODCUR) AND (CDS1.CODCUR IS NULL)))
									  ...
									  FROM (SELECT CDS.CODLOC,
											 ...
											 WHERE CDS.CODCONC = P_CODCONC
												   ...
												   AND NOT EXISTS (SELECT 1
													 ...
													 WHERE CDS.CODCONC = CDS1.CODCONC
														   AND CDS.CODCAD = CDS1.CODCAD
														   AND ((CDS.CODINSTITUICAO = CDS1.CODINSTITUICAO) AND (CDS.CODCUR = RCC.CODCUR) AND (CDS1.CODCUR IS NULL) AND (CDS.CODCAM = RCC.CODCAM) AND (CDS1.CODCAM IS NULL)))
											  ...
											  FROM (SELECT CDS.CODLOC,
													 ...
													 WHERE CDS.CODCONC = P_CODCONC
														   ...
														   AND NOT EXISTS (SELECT 1
															 ...
															 WHERE CDS.CODCONC = CDS1.CODCONC
																   AND CDS.CODCAD = CDS1.CODCAD
																   AND ((CDS.CODINSTITUICAO = CDS1.CODINSTITUICAO) AND (CDS.CODCUR = CDS1.CODCUR) AND (CDS1.CODCAM IS NULL) AND (CDS.CODCAM = RCC.CODCAM)))
														   AND NOT EXISTS (SELECT 1
															  FROM DBVESTIB.DISTRIBUICAO_CANDIDATO DCC
															 WHERE DCC.CODCONC = RCC.CODCONC
																   AND DCC.CODCONC = CDS.CODCONC
												  ...
												  FROM (SELECT CDS.CODLOC,
														 ...
														 WHERE CDS.CODCONC = P_CODCONC
															   ...
															   AND NOT EXISTS (SELECT 1
																 ...
																 WHERE CDS.CODCONC = CDS1.CODCONC
																	   AND CDS.CODCAD = CDS1.CODCAD
																	   AND (((CDS1.CODINSTITUICAO = RCC.CODINSTITUICAO) AND (CDS1.CODCUR IS NULL) AND (CDS1.CODCAM IS NULL)) OR ((CDS1.CODINSTITUICAO = RCC.CODINSTITUICAO) AND (CDS1.CODCUR IS NULL) AND (CDS1.CODCAM = RCC.CODCAM)) OR ((CDS1.CODINSTITUICAO = RCC.CODINSTITUICAO) AND (CDS1.CODCUR = RCC.CODCUR) AND (CDS1.CODCAM IS NULL)) OR ((CDS1.CODINSTITUICAO IS NULL) AND (CDS1.CODCUR = RCC.CODCUR) AND (CDS1.CODCAM = RCC.CODCAM)) OR ((CDS1.CODINSTITUICAO IS NULL) AND (CDS1.CODCUR IS NULL) AND (CDS1.CODCAM = RCC.CODCAM)) OR ((CDS1.CODINSTITUICAO IS NULL) AND (CDS1.CODCUR IS NULL) AND (CDS1.CODCAM IS NULL))))
															   AND NOT EXISTS (SELECT 1
																  FROM DBVESTIB.DISTRIBUICAO_CANDIDATO DCC
																 WHERE DCC.CODCONC = RCC.CODCONC
																	   AND DCC.CODCONC = CDS.CODCONC
